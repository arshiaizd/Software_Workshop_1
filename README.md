...
هر وظیفه به عضو مسئول اختصاص داده شد و متناسب با پیشرفت واقعی میان ستون‌ها جابه‌جا شد. دسترسی فعلی GitHub CLI مجوز `read:project` ندارد؛ بنابراین URL برد از API قابل تأیید نبود و برای جلوگیری از ثبت اطلاعات ساختگی، لینکی در این گزارش درج نشده است.
